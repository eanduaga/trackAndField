...
public class manageDiscipline extends javax.swing.JFrame {
    ...
    public manageDiscipline() {
        initComponents();
        JTableHeader header = jTable_disciplineData.getTableHeader();
    ...
    private void initComponents() {
        ...
        jLabel_viewDis = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jPanel_rightTable = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTable_disciplineData = new javax.swing.JTable();
        ...
        jLabel_title.setText("DISCIPLINE MANAGEMENT");
        ...
        jLabel_viewDis.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_viewDis.setForeground(new java.awt.Color(242, 242, 242));
        jLabel_viewDis.setText("View Disciplines");
        jPanel_leftMenu.add(jLabel_viewDis, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 490, 110, 20));
        ...
        if (jTable_disciplineData.getColumnModel().getColumnCount() > 0) {
            jTable_disciplineData.getColumnModel().getColumn(0).setPreferredWidth(5);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manageDiscipline.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public javax.swing.JLabel jLabel_viewDis;
