...
public class showOneDis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_codeDis = new javax.swing.JLabel();
        jLabel_maleWRDis = new javax.swing.JLabel();
        jLabel_descriptionDis = new javax.swing.JLabel();
        jLabel_femaleWRDis = new javax.swing.JLabel();
        ...
        jLabel_maleWRTitle = new javax.swing.JLabel();
        jLabel_femaleWRTitle = new javax.swing.JLabel();
        ...
        jLabel_codeDis.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_codeDis.setForeground(new java.awt.Color(52, 50, 46));
        jPanel1.add(jLabel_codeDis, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 200, 40));

        jLabel_maleWRDis.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_maleWRDis.setForeground(new java.awt.Color(52, 50, 46));
        jPanel1.add(jLabel_maleWRDis, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 250, 200, 40));

        jLabel_descriptionDis.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_descriptionDis.setForeground(new java.awt.Color(52, 50, 46));
        jPanel1.add(jLabel_descriptionDis, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 210, 200, 40));

        jLabel_femaleWRDis.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_femaleWRDis.setForeground(new java.awt.Color(52, 50, 46));
        jPanel1.add(jLabel_femaleWRDis, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 200, 40));
        ...
        jLabel_viewTitle.setText("DISCIPLINE INFO");
        ...
        jLabel_maleWRTitle.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        jLabel_maleWRTitle.setForeground(new java.awt.Color(52, 50, 46));
        jLabel_maleWRTitle.setText("Male World Record:");
        jPanel1.add(jLabel_maleWRTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, -1, 40));

        jLabel_femaleWRTitle.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        jLabel_femaleWRTitle.setForeground(new java.awt.Color(52, 50, 46));
        jLabel_femaleWRTitle.setText("Female World Record:");
        jPanel1.add(jLabel_femaleWRTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 290, -1, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showOneDis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new showOneDis().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel jLabel_codeDis;
    private javax.swing.JLabel jLabel_codeTitle;
    public javax.swing.JLabel jLabel_descriptionDis;
    private javax.swing.JLabel jLabel_descriptionTitle;
    private javax.swing.JLabel jLabel_exit;
    public javax.swing.JLabel jLabel_femaleWRDis;
    private javax.swing.JLabel jLabel_femaleWRTitle;
    public javax.swing.JLabel jLabel_maleWRDis;
    private javax.swing.JLabel jLabel_maleWRTitle;
