 ...
 * @author Eider
 */
public class manageAthlete extends javax.swing.JFrame {

    /**
     * Creates new form managePrueba
     */
    public manageAthlete() {
        initComponents();
        JTableHeader header = jTable_athleteData.getTableHeader();
    ...
    private void initComponents() {
        ...
        jLabel_viewAth = new javax.swing.JLabel();
        ...
        jLabel_title.setText("ATHLETE MANAGEMENT");
        ...
        jPanel_leftMenu.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 510, 100, 10));
        ...
        if (jTable_athleteData.getColumnModel().getColumnCount() > 0) {
            jTable_athleteData.getColumnModel().getColumn(0).setPreferredWidth(5);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manageAthlete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new manageAthlete().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel jLabel_viewAth;
    ...
    public javax.swing.JTable jTable_athleteData;
