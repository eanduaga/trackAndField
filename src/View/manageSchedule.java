...
public class manageSchedule extends javax.swing.JFrame {
    ...
    public manageSchedule() {
        initComponents();
        JTableHeader header = jTable_scheduleData.getTableHeader();
    ...
    private void initComponents() {
        ...
        jLabel_viewSch = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jPanel_rightTable = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTable_scheduleData = new javax.swing.JTable();
        ...
        jLabel_title.setText("SCHEDULE MANAGEMENT");
        ...
        jLabel_viewSch.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_viewSch.setForeground(new java.awt.Color(242, 242, 242));
        jLabel_viewSch.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel_viewSch.setText("View Schedule");
        jLabel_viewSch.setToolTipText("");
        jPanel_leftMenu.add(jLabel_viewSch, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 490, 110, 20));

        jSeparator2.setBackground(new java.awt.Color(242, 242, 242));
        jPanel_leftMenu.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 510, 110, 10));
        ...
        if (jTable_scheduleData.getColumnModel().getColumnCount() > 0) {
            jTable_scheduleData.getColumnModel().getColumn(0).setPreferredWidth(5);
        }
    ...
    public javax.swing.JLabel jLabel_viewSch;
