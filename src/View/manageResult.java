...
public class manageResult extends javax.swing.JFrame {
    ...
    public manageResult() {
        initComponents();
        JTableHeader header = jTable_resultData.getTableHeader();
    ...
    private void initComponents() {
        ...
        jLabel_viewRs = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jPanel_rightTable = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTable_resultData = new javax.swing.JTable();
        ...
        jLabel_title.setText("RESULT MANAGEMENT");
        ...
        jLabel_viewRs.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_viewRs.setForeground(new java.awt.Color(242, 242, 242));
        jLabel_viewRs.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel_viewRs.setText("View Results");
        jPanel_leftMenu.add(jLabel_viewRs, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 490, 90, 20));

        jSeparator2.setBackground(new java.awt.Color(242, 242, 242));
        jPanel_leftMenu.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 510, 90, 10));
        ...
        if (jTable_resultData.getColumnModel().getColumnCount() > 0) {
            jTable_resultData.getColumnModel().getColumn(0).setPreferredWidth(5);
        }
    ...
    public javax.swing.JLabel jLabel_viewRs;
    ...
    public javax.swing.JTable jTable_resultData;
