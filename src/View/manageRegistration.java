...
public class manageRegistration extends javax.swing.JFrame {
    ...
    public manageRegistration() {
        initComponents();
        JTableHeader header = jTable_registrationData.getTableHeader();
    ...
    private void initComponents() {
        ...
        jLabel_viewReg = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jPanel_rightTable = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTable_registrationData = new javax.swing.JTable();
        ...
        jLabel_title.setText("REGISTRATION MANAGEMENT");
        ...
        jLabel_viewReg.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel_viewReg.setForeground(new java.awt.Color(242, 242, 242));
        jLabel_viewReg.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel_viewReg.setText("View Registrations");
        jPanel_leftMenu.add(jLabel_viewReg, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 490, 130, 20));
        ...
        if (jTable_registrationData.getColumnModel().getColumnCount() > 0) {
            jTable_registrationData.getColumnModel().getColumn(0).setPreferredWidth(5);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manageRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new manageRegistration().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel jLabel_viewReg;
    ...
    public javax.swing.JTable jTable_registrationData;
