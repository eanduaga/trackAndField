...
import Model.CompetitionDataAccess;
...
public class read extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        CompetitionDataAccess compFunc = null;
        
        // Create an empty object
        Competition cmp = null;
        try {
            cmp = compFunc.readAll();
        } catch (IOException ex) {
            Logger.getLogger(read.class.getName()).log(Level.SEVERE, null, ex);
        }

        // Give values to the object using the information the user has entered in the textfields
        jTextArea1.setText(cmp.getCode());
        jTextArea1.setText(cmp.getName());
        jTextArea1.setText(cmp.getDescription());
        jTextArea1.setText(cmp.getLocation());
        jTextArea1.setText(cmp.getStartDate());
        jTextArea1.setText(cmp.getEndDate());
